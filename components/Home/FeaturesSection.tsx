  ...
  const features = [
    {
      ...
      description: "AI-powered task prioritization and intelligent assignment based on team capacity and skills.",
      icon: (
    ...
    },
    {
      ...
      description: "Seamless team communication with instant updates, comments, and file sharing across all devices.",
      icon: (
        <svg className="w-6 h-6 text-zinc-800 dark:text-zinc-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Comprehensive insights and reporting to track team performance and project progress.",
      icon: (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Everything you need to manage projects efficiently, from planning to deployment
          </p>
        </div>
